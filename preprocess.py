...
def load_data(dataset):
    ...
    if dataset == "SMD":
        ...
        file_list1 = listdir(path.join(dataset_folder, "test"))
        file_list2 = listdir(path.join(dataset_folder, "test_label"))
        ...
        dataset_folder = "datasets/EPC"
        output_folder = "datasets/EPC/processed"
        makedirs(output_folder, exist_ok=True)
        file_list = listdir(path.join(dataset_folder, "train"))
        file_list1 = listdir(path.join(dataset_folder, "test"))
        file_list2 = listdir(path.join(dataset_folder, "test_label"))
